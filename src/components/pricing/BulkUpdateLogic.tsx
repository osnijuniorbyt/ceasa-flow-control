...
import { BulkUpdateItem, UpdateMethod } from "./BulkUpdateTypes";

export function useBulkUpdateLogic() {
  ...
  const handleConfirmUpdates = async (data: any, csrfToken: string, filteredItems: BulkUpdateItem[]) => {
    try {
